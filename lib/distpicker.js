...
//    	debugger
    ...
    // eslint-disable-next-line class-methods-use-this
	    ...
	    key: 'getSelected',
	    value: function getSelected(dataType) {
	    	var self = this;
	    	var $selects = self.$element.find('select');
	    	var data;
	    	...
	    	$selects.each(function (i, select) {
	    		if(dataType == "array"){
		    	  	data.push($(select).children("option:selected").val());
	    		}else{
	 	    	 	$.extend(data, $(select).data());
	 	    	  	for(var key in $(select).data()){
	 	    		  	data[key] = {
	 	    				  code:$(select).children("option:selected").val(),
	 	    				  name:$(select).children("option:selected").text()
	 	    		  	}
	 	    	  	}
	    	  	}
	    	});
	    ...
	    key: 'setSelected',
	    value: function setSelected(datas) {
	    	var self = this;
	        var options = self.options;
	    	var $selects = self.$element.find('select');
