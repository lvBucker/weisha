	...
	getMtn:function(){
	   if (/(Android)/i.test(navigator.userAgent)) { 
			try { 
                ...
                alert('识别为安卓端,但是无法获取mtn,将mtn设置为e0ec76abc1575149dba5ba35cfcc8411'); 
                return  'e0ec76abc1575149dba5ba35cfcc8411';
            } 
        }else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
        	alert('识别为ios端,将mtn设置为e0ec76abc1575149dba5ba35cfcc8411'); 
            return  'e0ec76abc1575149dba5ba35cfcc8411';
        }else{
            alert('识别为pc端,将mtn设置为e0ec76abc1575149dba5ba35cfcc8411');
        }
        return
	},
	...
	closeWindow:function(){
		if (/(Android)/i.test(navigator.userAgent)) { 
        	...
        	try {
                ...
                alert('识别为ios端,但是无法关闭,测试地址为www.baidu.com'); 
            }
        }else{
            alert('识别为pc端,跳转出去');
